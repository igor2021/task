...
Заходим на сайт vestcap.com по сслыке [http://vestacp.com/docs/](http://vestacp.com/docs/). Видим что этот порт занять и имеет специальне назначение для "Vesta Control panel". Следовательно в конфигурационных файлах `nginx` и не должны видеть.
